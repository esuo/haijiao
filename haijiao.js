...
// ==UserScript==
// @name           haijiao_1-vip: 海角社区 解锁收费视频,VIP,去广告
// @namespace      https://github.com/sex4096/haijiao_vip
// @version        1.0.4
// @author         forgetme8
// @description    解锁 海角社区(haijiao_1.com) 收费视频,VIP,并去除网站广告, TG频道:@svip_nav.本插件完全免费,请注意甄别,避免上当受骗.
...
(function (React$1, ReactDOM, antd, icons) {
  ...
  const App = () => {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(antd.FloatButton, {
      ...
      initialSettings: {
        ...
        host: PluginStore.get("host", "https://haijiao.4096se.com")
      },
  ...
  function initSetting() {
    ...
    pluginDiv.id = "haijiao_1-vip-plugin";
